    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload_to', filer.fields.folder.FilerFolderField(on_delete=models.CASCADE, verbose_name='Upload files to', to='filer.Folder', help_text='Select a folder to which all files submitted through this field will be uploaded to.')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field', models.ForeignKey(on_delete=models.CASCADE, editable=False, to='aldryn_forms.FieldPlugin')),
            ],
            options={
            },
            bases=(models.Model,),
