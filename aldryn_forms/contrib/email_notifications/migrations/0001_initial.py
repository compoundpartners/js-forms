    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('to_user', models.ForeignKey(verbose_name='to user', on_delete=models.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            ...
            name='form',
            field=models.ForeignKey(related_name='email_notifications', on_delete=models.SET_NULL, to='email_notifications.EmailNotificationFormPlugin'),
